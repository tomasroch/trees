...
export const exampleNodes = [
    {
        id: '1',
        position: {x: -32, y: 0},
        data: {result: '40', newResult:[
                {value:"39", nodesNewResult:[
                        {id:"11", result:""},
                    ]
                },
                {value:"45", nodesNewResult:[
                        {id:"6", result:""}
                    ]
                }
    ...
    },
    {
        id: '3',
        position: {x: 228, y: 70},
        data: {result: '50', width:width, placeHolder: ""},
        hidden: false,
        type:'deleteNode'
    },
    // 3. rada
    ...
    },
    {
        ...
        data: {result: '37', width:width, placeHolder: ""},
        hidden: false,
        type:'deleteNode'
    },
    {
        id: '6',
        position: {x: 96, y: 140},
        data: {result: '45', width:width, placeHolder: ""},
        hidden: false,
        type:'deleteNode'
    },
    {
        ...
        data: {result: '53', width:width, placeHolder: ""},
        hidden: false,
        type:'deleteNode'
    },
    // 4. rada
    {
        ...
        data: {result: '2', width:width, placeHolder: ""},
        hidden: false,
        type:'deleteNode'
    },
    {
        ...
        data: {result: '8', width:width, placeHolder: ""},
        hidden: false,
        type:'deleteNode'
    },
    {
    ...
    },
    {
        id: '11',
        position: {x: -96, y: 210},
        data: {result: '39', width:width, placeHolder: ""},
        hidden: false,
        type:'deleteNode'
    },
    {
