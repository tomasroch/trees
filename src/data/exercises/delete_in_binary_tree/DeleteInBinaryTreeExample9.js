...
export const exampleNodes = [
    {
        id: '1',
        position: {x: -32, y: 0},
        data: {result: '33', newResult:[
                {value:"25", nodesNewResult:[
                        {id:"11", result:""},
                    ]
                },
                {value:"35", nodesNewResult:[
                        {id:"6", result:""}
                    ]
                }
    ...
    //2. rada
    {
        id: '2',
        position: {x: -292, y: 70},
        data: {result: '17', width:width, placeHolder: ""},
        hidden: false,
        type:'deleteNode'
    },
    {
        id: '3',
        position: {x: 228, y: 70},
        data: {result: '43', width:width, placeHolder: ""},
        hidden: false,
        type:'deleteNode'
    },
    // 3. rada
    {
        ...
        data: {result: '13', width:width, placeHolder: ""},
        hidden: false,
        type:'deleteNode'
    },
    {
    ...
    },
    {
        id: '6',
        position: {x: 96, y: 140},
        data: {result: '35', width:width, placeHolder: ""},
        hidden: false,
        type:'deleteNode'
    },
    {
    ...
    // 4. rada
    {
        ...
        data: {result: '3', width:width, placeHolder: ""},
        hidden: false,
        type:'deleteNode'
    },
    {
