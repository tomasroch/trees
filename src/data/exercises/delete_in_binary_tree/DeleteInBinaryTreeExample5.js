...
export const exampleNodes = [
    {
        id: '1',
        position: {x: -32, y: 0},
        data: {result: '18', newResult:[
                {value:"13", nodesNewResult:[
                        {id:"11", result:""},
                    ]
                },
                {value:"28", nodesNewResult:[
                        {id:"6", result:"38"},
                        {id:"13", result:"48"},
                        {id:"29", result:""},
                    ]
    ...
    //2. rada
    {
        id: '2',
        position: {x: -292, y: 70},
        data: {result: '6', width:width, placeHolder: ""},
        hidden: false,
        type:'deleteNode'
    },
    {
    ...
    },
    {
        ...
        data: {result: '11', width:width, placeHolder: ""},
        hidden: false,
        type:'deleteNode'
    },
    {
    ...
    },
    {
        ...
        data: {result: '38', width:width, placeHolder: ""},
        hidden: false,
        type:'deleteNode'
    },
    {
    ...
    },
    {
        id: '29',
        position: {x: 192, y: 280},
        data: {result: '48', width:width, placeHolder: ""},
        hidden: false,
        type:'deleteNode'
    },
    {
